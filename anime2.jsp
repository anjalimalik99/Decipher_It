...
.fish{
	...
	-webkit-animation-timing-function: wave;
}
...
<div style="position:absolute;border:6px solid white;margin-top:400px;margin-left:300px;height:150px;width:700px">
<h1 style="position:absolute;font-size:40px;margin-top:50px">Your Score is:
<%     int score=0;
try {
